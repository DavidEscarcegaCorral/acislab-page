  ...
  return (
    ...
    >
      ...
      <input 
        ...
        id="sidebar-search" 
        name="q"
        className="block w-full p-2 pl-10 text-sm border border-slate-200 dark:border-slate-700 rounded-lg bg-white dark:bg-slate-800 focus:ring-sky-500 focus:border-sky-500"
